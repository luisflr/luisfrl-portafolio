...
function MaterialUIIcon({ wrapperClassName=""}) {
  return (
    <svg preserveAspectRatio="xMidYMid" viewBox="0 0 256 204" xmlns="http://www.w3.org/2000/svg" className={wrapperClassName}>
      <path 
