...
function DescriptionTimeline({
  typeProject, titleProject, linksProject, reverse, description, techStack
}) {
  return (
    <>
      <p className={`${reverse ? 'float-right pr-3' : 'pl-3'} text-[#A3B3BC] w-fit text-sm font-open-sans font-bold tracking-wide`}>{typeProject}</p>
    ...
    <div className={`${reverse ? 'pl-[1px] mr-3' : 'pr-[1px] ml-3' } bg-gradient-to-r from-sky to-cyan w-fit pt-[1px] pb-[1px] mb-4`}>
        <p className='h-full bg-background p-3 text-[#A3B3BC] text-sm font-open-sans font-bold tracking-wide leading-6'>
        {description}
        </p>
    </div>
